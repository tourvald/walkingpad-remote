...
enum TrainingTelemetryWriter {
    ...
    nonisolated static let trainingCsvHeaders: [String] = [
        ...
        "speed_display_value",
        "speed_display_units",
        "speed_display_semantics",
        "speed_physical_kmh_estimate",
        "speed_physical_estimate_label",
        "speed_unit_pref",
        "command_units",
        "display_units",
    ...
    nonisolated static func csvRow(sourceFile: String, payload: [String: Any]) -> [String] {
        ...
        return [
            ...
            csvString(payload["speed_display_value"]),
            csvString(payload["speed_display_units"]),
            csvString(payload["speed_display_semantics"]),
            csvString(payload["speed_physical_kmh_estimate"]),
            csvString(payload["speed_physical_estimate_label"]),
            ...
            csvString(payload["speed_cap_source"]),
