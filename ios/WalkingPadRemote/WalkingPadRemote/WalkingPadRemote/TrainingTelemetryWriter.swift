...
enum TrainingTelemetryWriter {
    ...
    nonisolated static let trainingCsvHeaders: [String] = [
        ...
        "app_state_previous",
        "app_state",
        "workout_lifecycle_stage",
        "workout_committed",
        "background_policy_action",
        "background_policy_reason",
        "background_control_loop_permitted",
        "native_hr_provider_state",
        "hr_last_factual_at",
        "hr_last_received_at",
        "hr_last_age_s",
        "treadmill_connection_state",
        ...
        "stop_attempt_at",
        "stop_attempt_source",
        "stop_command_sent_at",
        "stop_command_status",
        "stop_confirmed_ever",
        "stop_currently_confirmed",
        "stop_invalidation_reason",
        "stop_peripheral_id",
        "stop_connection_epoch",
        "stop_notification_stream_id",
        "stop_observation_sequence",
        "stop_observation_count",
        "stop_observation_at",
        "stop_observation_age_s",
        "stop_device_speed_raw_tenths",
        "stop_device_state",
        "stop_fe01_checksum_valid",
        "stop_fresh",
        "stop_confirmation_predicate",
        "stop_confirmation_result",
        "stop_first_confirmed_at",
        "stop_first_confirmed_elapsed_s",
        "stop_final_result",
        "stop_unconfirmed_reason",
        "stop_freshness_limit_s",
        "stop_observation_window_s",
        "stop_checkpoint_delay_s",
        "raw_json"
    ]
    ...
    nonisolated static func csvRow(sourceFile: String, payload: [String: Any]) -> [String] {
        ...
        return [
            ...
            csvString(payload["app_state_previous"]),
            csvString(payload["app_state"]),
            csvString(payload["workout_lifecycle_stage"]),
            csvString(payload["workout_committed"]),
            csvString(payload["background_policy_action"]),
            csvString(payload["background_policy_reason"]),
            csvString(payload["background_control_loop_permitted"]),
            csvString(payload["native_hr_provider_state"]),
            csvString(payload["hr_last_factual_at"]),
            csvString(payload["hr_last_received_at"]),
            csvString(payload["hr_last_age_s"]),
            csvString(payload["treadmill_connection_state"]),
            csvString(payload["treadmill_control_ready"]),
            csvString(payload["treadmill_protocol"]),
            ...
            csvString(payload["stop_attempt_at"]),
            csvString(payload["stop_attempt_source"]),
            csvString(payload["stop_command_sent_at"]),
            csvString(payload["stop_command_status"]),
            csvString(payload["stop_confirmed_ever"]),
            csvString(payload["stop_currently_confirmed"]),
            csvString(payload["stop_invalidation_reason"]),
            csvString(payload["stop_peripheral_id"]),
            csvString(payload["stop_connection_epoch"]),
            csvString(payload["stop_notification_stream_id"]),
            csvString(payload["stop_observation_sequence"]),
            csvString(payload["stop_observation_count"]),
            csvString(payload["stop_observation_at"]),
            csvString(payload["stop_observation_age_s"]),
            csvString(payload["stop_device_speed_raw_tenths"]),
            csvString(payload["stop_device_state"]),
            csvString(payload["stop_fe01_checksum_valid"]),
            csvString(payload["stop_fresh"]),
            csvString(payload["stop_confirmation_predicate"]),
            csvString(payload["stop_confirmation_result"]),
            csvString(payload["stop_first_confirmed_at"]),
            csvString(payload["stop_first_confirmed_elapsed_s"]),
            csvString(payload["stop_final_result"]),
            csvString(payload["stop_unconfirmed_reason"]),
            csvString(payload["stop_freshness_limit_s"]),
            csvString(payload["stop_observation_window_s"]),
            csvString(payload["stop_checkpoint_delay_s"]),
            jsonString(payload)
        ]
    }
}
