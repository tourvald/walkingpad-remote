...
| HR-control on confirmedImperial with session manual-stop acknowledgement | `restricted allowed` | Only for the matching treadmill fingerprint; speed uses existing device/app bounds after removal of the artificial `6.0 km/h` cap; app STOP remains best-effort. | [units_and_setunit.md](units_and_setunit.md), [ks_f0_case_notes.md](ks_f0_case_notes.md) |
