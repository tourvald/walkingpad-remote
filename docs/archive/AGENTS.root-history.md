# Historical root AGENTS notes

> Archived from the root instruction chain by Issue #2. This file preserves historical context and is not an active agent contract.
