# Historical iOS AGENTS notes

> Archived from the iOS instruction chain by Issue #2. This file preserves historical context and is not an active agent contract.
